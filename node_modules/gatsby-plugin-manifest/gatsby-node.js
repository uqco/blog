...
exports.onPostBootstrap = function (args, pluginOptions) {
  return new Promise(function (resolve, reject) {
    var icon = pluginOptions.icon,
        manifest = (0, _objectWithoutPropertiesLoose2.default)(pluginOptions, ["icon"]); // Delete options we won't pass to the manifest.webmanifest.
    ...
    var iconPath = path.join("public", path.dirname(manifest.icons[0].src)); //create destination directory if it doesn't exist
